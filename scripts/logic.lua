...
function baby_woodfall_temple()
    return baby_woodfall() and can_play_sonata()
end
...
function baby_clear_woodfall()
    return baby_woodfall_temple() and has("bow") and baby_can_smack_hard() and has("bk_wf") and has("odolwa")
end
function clear_woodfall() -- was "clear_woodfall"
    return woodfall_temple() and has("bow") and can_smack() and (has("bk_wf") or has("odolwa"))
end
...
function baby_snowhead_temple()
    return baby_moutain_village() and has("goron") and can_play_lullaby() and has("magic")
end
...
function baby_clear_snowhead()
    return baby_snowhead_temple() and can_use_fire_arrows() and has("bosskey_sh") and has("smallkey_sh")--[[need to revisit]] and baby_has_explosives()
end
function clear_snowhead()
    return snowhead_temple() and--[[(can_use_fire_arrows() and has("bosskey_sh") and has("smallkey_sh", 3) and has_explosives()) or]] (can_use_fire_arrows() and has("smallkey") and has("bosskey_sh")) or (can_use_fire_arrows() and has("goht"))
end
...
function baby_clear_greatbay()
    return has("zora") and can_use_ice_arrows() and has("fairymask") and can_use_fire_arrows() and has("smallkey_gb") and has("bosskey_gb") and has("bow")
end
function clear_greatbay()
    return has("zora") and can_use_ice_arrows() and can_use_fire_arrows() and (has("bosskey_gb") or has("gyorg"))
end
...
function baby_stone_tower_temple()
    return baby_ikana_canyon() and can_use_ice_arrows() and can_play_elegy() and has("goron") and has("zora")
end
